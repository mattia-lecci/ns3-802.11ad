...
main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("game", "The gaming server type [\"CrazyTaxi\", \"FourElements\"]", gameType );
  ...
  LogComponentEnable ("GameStreamingApplication", LOG_LEVEL_INFO);
  ...
  GameStreamingApplicationHelper serverStreamingHelper (gamingServerId, interfaces.GetAddress (0), 9);
  ...
  GameStreamingApplicationHelper clientStreamingHelper (gamingClientId, interfaces.GetAddress (1), 9);
